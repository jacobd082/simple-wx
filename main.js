...
function setZIP() {
  document.getElementById("zipr").innerHTML =
    "<img src='load.gif' width='40px'>Please wait...";
  fetch(
    "https://api.openweathermap.org/geo/1.0/zip?zip=" +
      document.getElementById("zip").value +
      "," +
      document.getElementById("zip-c").value +
      "&appid=b4b150ac011d2c689bb0960425153055"
  )
...
function handleZIP(e) {
  if (e.name == undefined) {
    ...
    document.getElementById("zipr").innerHTML =
      "<p>Location was saved as " +
      e.name +
      ". Weather will open shortly... <img src='load.gif' width='40px'></p>";
    Toastify({
...
function setGPS() {
  ...
  function error(err) {
    ...
    alert(
      "There was an error getting your location. Please make sure it is on and try again."
    );
    Toastify({
...
function getWX() {
  document.body.innerHTML =
    "<center><h1>Please wait... <img src='load.gif' width='40px'></h1></center>";
  fetch(
...
function configS(loca, cond, temp, icon) {
  document.body.innerHTML =
    ...
    loca +
    '. <a href="javascript:setGPS()">Reset</a></div><div class="container"><div class="center">     <img src="Logo.png" width="15px"><span style="font-size:15px;margin: 0;">Simple Weather</span><br>' +
    icon +
    '<h1 style="margin-top: 2px;">It is ' +
    cond +
    '.</h1><p>Project by <a href="https://zzz.jacobdrath.co">Jacob Drath</a>.<br><a id="settings" href="settings">Settings</a></div></div>';
